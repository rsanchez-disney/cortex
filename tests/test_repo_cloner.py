...
from cortex.repo_cloner import (
    clone_repos,
    deduplicate_urls,
...
class TestGenerateLocalConfig:
    ...
    def test_header_comment(self) -> None:
        ...
        assert result.startswith("# Auto-generated by `cortex clone-repos`.")
...
class TestCloneRepos:
    ...
    def test_clones_unique_urls(self, tmp_path: Path) -> None:
        ...
        with patch("cortex.repo_cloner._clone_single_repo") as mock_clone:
    ...
    def test_handles_clone_failure(self, tmp_path: Path) -> None:
        ...
        with patch("cortex.repo_cloner._clone_single_repo", side_effect=side_effect):
            result = clone_repos(repos, clone_dir, "fake-pat")
    ...
    def test_url_to_clone_name_populated(self, tmp_path: Path) -> None:
        ...
        with patch("cortex.repo_cloner._clone_single_repo"):
            result = clone_repos(repos, clone_dir, "fake-pat")
